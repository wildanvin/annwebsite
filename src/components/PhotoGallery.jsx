      ...
      <motion.div className='flex flex-wrap justify-center gap-10 md:gap-12'>
        {photos.map((photo, index) => (
          <motion.div
            ...
            } hover:shadow-2xl transition-all duration-300 cursor-pointer w-full sm:w-[calc(50%-2.25rem)] lg:w-[calc(33.333%-2.5rem)]`}
          ...
          >
            ...
            >
              <span className='text-sm text-pink-600 whitespace-nowrap'>
                {photo.alt}
              </span>
            </motion.div>
        ...
        {selectedPhoto && (
          ...
          >
            ...
            >
              ...
              <div className='absolute -bottom-6 -right-6 text-4xl animate-float-delay'>
                ✨
              </div>
